...
let isQPROP = process.argv[3] == "true";
let toSpawn = ServicesJane_1.mapToName(process.argv[2]);
...
let ownIp = process.argv[7];
let ownPort = parseInt(process.argv[8]);
let monitorIP = process.argv[9];
let monitorPort = parseInt(process.argv[10]);
let dynLinks = [];
if (changes == 1) {
...
switch (toSpawn) {
    case "admitter":
        new ServicesJane_1.Admitter(ownIp, ownPort, monitorIP, monitorPort, totalVals, csvFile, dataRate, 10, dynLinks, changes);
        break;
    case "monitor":
    ...
    case "pi58":
        ...
        break;
    case "pi59":
        new ServicesJane_1.SinkService(isQPROP, dataRate, totalVals, csvFile, ownIp, ownPort, monitorIP, monitorPort, exports.pi59.tag, exports.pi59.parents, exports.pi59.children, 10, changes);
        break;
    default:
        throw new Error("unknown spawning argument: " + toSpawn + " : " + ownIp + " : " + monitorIP);
}
/*export function spawnPi(toSpawn,isQPROP,dataRate,totalVals,csvFile,changes,ownIp,ownPort,monitorIP,monitorPort){
