...
let toSpawn     = mapToName(process.argv[2])
...
switch (toSpawn){
    case "admitter":
         new Admitter(ownIp,ownPort,monitorIP,monitorPort,totalVals,csvFile,dataRate,10,dynLinks,changes)
        break;
    ...
    case "pi58":
         new DerivedService(isQPROP,dataRate,totalVals,csvFile,ownIp,ownPort,monitorIP,monitorPort,pi58.tag,pi58.parents,pi58.children, changes)
            break;
    case "pi59":
         new SinkService(isQPROP,dataRate,totalVals,csvFile,ownIp,ownPort,monitorIP,monitorPort,pi59.tag,pi59.parents,pi59.children,10,changes)
            break;
    default:
