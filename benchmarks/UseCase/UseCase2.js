...
const QPROPActor2_1 = require("../../src/QPROP/QPROPActor2");
...
class QPROPConfigService2 extends QPROPActor2_1.QPROPActor2 {
...
exports.QPROPConfigService2 = QPROPConfigService2;
class QPROPDataAccessService2 extends QPROPActor2_1.QPROPActor2 {
    constructor(rate, totalVals, csvFileName, ownType, okType, parentTypes, childTypes, psServerAddress = "127.0.0.1", psServerPort = 8000) {
        super(ownType, parentTypes, childTypes, psServerAddress, psServerPort);
        this.rate = rate / 2;
        this.totalVals = totalVals / 2;
...
exports.QPROPDataAccessService2 = QPROPDataAccessService2;
class QPROPGeoService2 extends QPROPActor2_1.QPROPActor2 {
    ...
    start(imp) {
        console.log("Geo2 ready");
        let propagated = 0;
        return this.lift((fleetData) => {
            propagated++;
...
exports.QPROPGeoService2 = QPROPGeoService2;
class QPROPDrivingService2 extends QPROPActor2_1.QPROPActor2 {
    constructor(rate, totalVals, csvFileName, ownType, parentTypes, childTypes, psServerAddress = "127.0.0.1", psServerPort = 8000) {
        super(ownType, parentTypes, childTypes, psServerAddress, psServerPort);
        this.close = false;
        this.thisDir = __dirname;
...
exports.QPROPDrivingService2 = QPROPDrivingService2;
class QPROPDashboardService2 extends QPROPActor2_1.QPROPActor2 {
...
exports.QPROPDashboardService2 = QPROPDashboardService2;
class UseCaseApp2 extends spiders_js_1.Application {
    constructor() {
...
exports.UseCaseApp2 = UseCaseApp2;
