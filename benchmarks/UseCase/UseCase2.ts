...
import {QPROPActor2} from "../../src/QPROP/QPROPActor2";
...
export class QPROPConfigService2 extends QPROPActor2{
    FleetData
    rate
    totalVals
    memWriter
...
export class QPROPDataAccessService2 extends QPROPActor2{
    rate
    totalVals
    memWriter
    averageMem
...
export class QPROPGeoService2 extends QPROPActor2{
    memWriter
    averageMem
    close
    thisdir
...
export class QPROPDrivingService2 extends QPROPActor2{
    memWriter
    averageMem
    close
    rate
...
export class QPROPDashboardService2 extends QPROPActor2{
    memWriter
    averageMem
    averageResults
    close
...
export class UseCaseApp2 extends Application{
    completeResolve
    constructor(){
