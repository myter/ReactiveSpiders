...
const ReactiveApplication_1 = require("../ReactiveApplication");
...
exports.QPROP = QPROP;
class QPROPApplication extends ReactiveApplication_1.ReactiveApplication {
    constructor(ownType, parentTypes, childTypes, myAddress, myPort, psServerAddress = "127.0.0.1", psServerPort = 8000) {
        super(new ReactiveMirror_1.ReactiveMirror(new QPROP()), myAddress, myPort);
